...
## Proposal
A database management system that is built specifically to allow and optimize limited analytics to be performed on top of sensitive data without revealing the underlying raw data.
